...
Add_N_LONGOP proc valA:DWORD, valB:DWORD, result:DWORD, dwordNum:DWORD
	mov esi, valA
	mov ebx, valB
	mov edi, result
...
Sub_N_LONGOP proc valA:DWORD, valB:DWORD, result:DWORD, bits:DWORD
	mov esi, valA
	mov ebx, valB
	mov edi, result
...
Mul_NxN_LONGOP proc opA:DWORD, opB:DWORD, result:DWORD, dwordnumFirst:DWORD, dwordnumSecond:DWORD
